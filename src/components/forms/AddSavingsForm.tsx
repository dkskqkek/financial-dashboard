...
export function AddSavingsForm() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const monthsDiff = (maturityDate.getFullYear() - startDate.getFullYear()) * 12 + 
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            예금, 적금, CMA 등의 금융 상품 정보를 추가하세요.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label htmlFor="savingsType" className="text-sm font-medium">상품 구분</label>
            <select
              id="savingsType"
              name="savingsType"
              value={formData.type}
          ...
          <div>
            <label htmlFor="bankName" className="text-sm font-medium">은행/기관명</label>
            <Input
              id="bankName"
              name="bankName"
          ...
          <div>
            <label htmlFor="productName" className="text-sm font-medium">상품명</label>
            <Input
              id="productName"
              name="productName"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <label htmlFor="principal" className="text-sm font-medium">원금</label>
              <Input
                id="principal"
                name="principal"
                type="number"
            ...
            <div>
              <label htmlFor="savingsInterestRate" className="text-sm font-medium">금리 (%)</label>
              <Input
          ...
          <div>
            <label htmlFor="savingsMaturityDate" className="text-sm font-medium">만기일</label>
            <Input
